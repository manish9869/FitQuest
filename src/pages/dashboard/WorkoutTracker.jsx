...
import { Dumbbell, Plus, Trash2, Clock, Flame, Zap, ChevronRight, Search, Check } from 'lucide-react';
...
export default function WorkoutTracker() {
    ...
    const { data: workouts = [] } = useQuery({
        queryKey: ['workouts', todayStr, user?.email],
        queryFn: () => entities.WorkoutLog.filter({ user_email: user?.email, date: todayStr }),
        enabled: !!user?.email,
    });
